mixin CategoryScreenLocale {
  ...
  static const categoryEditButton = 'category_edit_button';
  ...
  static const categoryUpdateSuccess = 'category_update_success';
  static const categoryUpdateError = 'category_update_error';

  static const categoryDeleteSuccess = 'category_delete_success';
  static const categoryDeleteError = 'category_delete_error';
  ...
  static const MM = {
    ...
    categoryUpdateSuccess: 'အမျိုးအစားကို အောင်မြင်စွာ ပြင်ဆင်ပြီးပါပြီ',
    categoryUpdateError: 'အမျိုးအစား ပြင်ဆင်မှု မအောင်မြင်ပါ',

    categoryDeleteSuccess: 'အမျိုးအစားကို အောင်မြင်စွာ ဖျက်ပြီးပါပြီ',
    categoryDeleteError: 'အမျိုးအစား ဖျက်မှု မအောင်မြင်ပါ',
