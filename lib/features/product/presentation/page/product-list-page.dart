...
//             ),
//             Expanded(
//               child: ProductListByAdminAndManager(searchQuery: searchQuery),
//             ),
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            // 👇 ဒီနေရာသာ ပြောင်းထားပါတယ်
            // ProductListByAdminAndManager (item widget) အစား
            // ProductLists (list-level, pagination widget) ကို ခေါ်ပါတယ်
...
class ProductLabel extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          if (isAdmin(user!.role) || isManager(user.role)) ...[UserSelect()],
        ],
      ),
    );
  }
