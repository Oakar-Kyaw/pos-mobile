...
class AccountUpgradePages extends ConsumerStatefulWidget {
  const AccountUpgradePages({super.key});

  @override
  ConsumerState<AccountUpgradePages> createState() => _AccountUpgradePages();
}

class _AccountUpgradePages extends ConsumerState<AccountUpgradePages> {
  @override
